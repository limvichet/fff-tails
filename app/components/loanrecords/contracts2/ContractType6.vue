  ...
  <div v-if="!loading && dd" class="page">
    ...
    <main class="mt">
          ...
          <section>
            ...
            <p class="justify inden margin-l-40">
              ទោះបីមូលប្បទានប័ត្រទាំង៤ សន្លឹកដូចក្នុងប្រការ២ ចេញតែឈ្មោះ <b>{{loanrecord.customer.cust_name_1 }}</b> ឬឈ្មោះ <c>{{loanrecord.customer.cust_name_2 }}</c> ឬឈ្មោះ <strong>{{loanrecord.guarantor.cust_name_1}}</strong>
          ...
          <!-- ប្រការ៩-->
          <section>
            <p class="mt muol fs-10">ប្រការ៩_កាតព្វកិច្ចអ្នកធានាលើបំណុល ភាគី“គ”</p>
            <p class="justify inden margin-l-40">
          ...
          <!-- ប្រការ១០-->
          <section>
            <p class="mt muol fs-10">ប្រការ១០_ច្បាប់ដែលមានសមត្ថកិច្ច</p>
