  ...
  <div v-if="!loading && dd" class="page">
    ...
    <main class="mt">
          ...
          <section>
            ...
            <p class="justify inden margin-l-40">
              ទោះបីមូលប្បទានប័ត្រទាំង៤ សន្លឹកដូចក្នុងប្រការ២ ចេញតែឈ្មោះ <strong>{{loanrecord.customer.cust_name_1 }}</strong> ឬឈ្មោះ <strong>{{loanrecord.customer.cust_name_2 }}</strong>
