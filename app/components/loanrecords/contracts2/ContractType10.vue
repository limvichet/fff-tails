    ...
    <main class="mt">
          ...
          <section>
            <p class="justify inden">
              ...
              និង{{ loanrecord.customer.nametitle2.nametitle_kh }} <span class="muol fs-10">{{ loanrecord.customer.cust_name_2 }}</span> កើតឆ្នាំ{{ numUnicode(formatYear(loanrecord!.customer.cust_dob_2)) }}
              កាន់{{ loanrecord.customer.identification2?.identification_kh }}លេខ{{ numUnicode(loanrecord.customer.cust_idcardnum_2) }} ចុះ{{ formatFullDate(loanrecord.customer.cust_idcardnum_date_2) }}
              មានអាសយដ្ឋានស្ថិតនៅ{{ loanrecord.customer.cust_address }} ជាអ្នកខ្ចីប្រាក់<span class="muol fs-10">(កូនបំណុល)</span> តទៅហៅកាត់ថា <span class="muol fs-10">ភាគី “ខ”</span> ។
            </p>
          </section>
          ...
          <section>
            ...
            <p class="justify inden margin-l-40">
              <span v-if="loanrecord.loan_collateraltype_id == 2">
                ដើម្បីជាការទុកចិត្ត និងការគោរពនូវប្រាក់ដែល ភាគី“ខ” បានខ្ចីពី ភាគី“ក” នោះភាគី“ខ” យល់ព្រម និងឯកភាពធ្វើលិខិតទិញ-លក់ផ្តាច់  និងផ្ទេរសិទ្ធិទៅលើចលនវត្ថុដែល​មានចែងក្នុងប្រការ៦មកឲ្យភាគី“ក” ជាម្ចាស់កម្មសិទ្ធិករហើយឯកសារទាំងនោះ​ត្រូវបានតម្កល់ទុកនៅភាគី“ក”។ នៅពេលដែលភាគី“ខ” មិនបានបង់ប្រាក់តាមការសន្យា ដូចមានចែងក្នុងប្រការ១ និងប្រកាស២នោះ ភាគី“ខ” យល់ព្រមលក់ផ្ដាច់ដីដែលបានដាក់បញ្ចាំ​ក្នុងប្រការ៦ មកឲ្យភាគី“ខ” ក្នុងតម្លៃជំពាក់ដែលនៅសល់។
              </span>
              <span v-else>
          ...
          <!-- ប្រការ១១ -->
          <section>
            <p class=" mt muol fs-10">ប្រការ១១_កាតព្វកិច្ចអ្នកធានាលើបំណុល ភាគី“គ”</p>
            <p class="justify inden margin-l-40">
              ដើម្បីធានាបំណុលភាគី“គ” ឯកភាពចូលរួមទទួលខុសត្រូវ ធានាសងបំណុលជំនួស ភាគី“ខ” ប្រសិនបើភាគី“ខ” មិនគោរពតាមប្រការណាមួយ នៃកិច្ចសន្យាខាងលើនេះ និងមានបំណងគេចវេសមិនព្រមបង់ការប្រាក់ ឬប្រាក់ដើមជូនទៅភាគី“ក” ឬមិនគោរពកាតព្វកិច្ចណាមួយ។
            </p>
          </section>

          <!-- ប្រការ១២-->
          <section>
            <p class="mt muol fs-10">ប្រការ១២_ច្បាប់ដែលមានសមត្ថកិច្ច</p>
