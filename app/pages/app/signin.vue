...
import { generateAdvancedDeviceIdentifier } from '~/utils/deviceIdentifier'
...
const submitForm = handleSubmit(
  ...
  async (data) => {
    ...
    const payload = {
      ...data,
      identifier_token: fields.identifier_token.model.value,
    };
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-2 sm:mb-8">
                <h1 class="mb-1 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                  Sign In
                </h1>
                    ...
                    <div>
                      <div class="flex items-center justify-between">
                        <label for="email" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                          Email </label>
                        <span v-if="isSubmitted || errors.email" class="text-red-500 font-normal text-[12px]">{{
                          errors.email }}</span>
                      </div>
                      <input v-model="fields.email.model.value" v-bind="fields.email.props" type="email" id="email"
                    ...
                    <div>
                      <div class="flex items-center justify-between">
                        <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                          Password </label>
                        <span v-if="isSubmitted || errors.password" class="text-red-500 font-normal text-[12px]"> {{
                          errors.password }}</span>
                      </div>
                      <div class="relative">
                        <input v-model="fields.password.model.value" v-bind="fields.password.props"
