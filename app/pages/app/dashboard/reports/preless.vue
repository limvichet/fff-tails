          ...
          <table class="min-w-full">
            <thead
              ...
              <tr class="border-b border-gray-200 dark:border-gray-700 text-xs font-bold">
                ...
                <th class="px-1" py-1>ថ្ងៃខែឆ្នាំត្រូវបង់ប្រាក់</th>
                <th class="px-1" py-1>វិក្កយបត្រ</th>
                <th class="px-1" py-1>សាច់ប្រាក់</th>
                <th class="px-1" py-1>អ្នកទទួលប្រាក់</th>
                <th class="px-1" py-1>អ្នកបញ្ចូលទិន្ន័យ</th>
                <th class="px-1" py-1>ថ្ងៃខែឆ្នាំបញ្ចូលប្រាក់</th>
