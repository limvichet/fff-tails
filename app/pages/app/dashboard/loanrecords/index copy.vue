...
const openPrintModal = async (url: string) => {
  printUrl.value = url
  ...
  <div class="grid grid-cols-1">
              ...
              >
                ...
                <td class="px-1 py-1 text-sm">
                  <div v-if="l.count_schedule > 0" class="flex flex-wrap items-center justify-left gap-1 py-1 sm:px-6">
                    ...
                    <button
                      @click="openPrintModal(`/app/dashboard/schedules/prints/${l.id}/print-sched`)"
    ...
    <div v-if="showModal" class="modal-backdrop">
      <div class="modal-content">
        ...
        <!-- LOADING -->
        <div v-if="!iframeLoaded" class="text-center py-4">
          Loading preview...
        </div>
...
.modal-content {
  ...
  height: 75vh;        /* ✅ FIX: force vertical size */
