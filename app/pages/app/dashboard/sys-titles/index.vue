          ...
          <table class="min-w-full">
            <thead>
              <tr class="border-b border-gray-200 dark:border-gray-700">
                <th scope="col" class="px-4 py-2 text-left text-sm font-semibold uppercase tracking-wider w-[10%]">#
                </th>
                <th scope="col" class="px-4 py-2 text-left text-sm font-semibold uppercase tracking-wider w-[10%]">Khmer
                </th>
                <th scope="col" class="px-4 py-2 text-left text-sm font-semibold uppercase tracking-wider w-[10%]">
                  English</th>
                <th scope="col" class="px-4 py-2 text-left text-sm font-semibold uppercase tracking-wider w-[10%]">
                  Status</th>
                <th scope="col" class="px-4 py-2 text-left text-sm font-semibold uppercase tracking-wider w-[20%]">
                  Created</th>
                <th scope="col" class="px-4 py-2 text-left text-sm font-semibold uppercase tracking-wider w-[20%]">
                  Updated</th>
      ...
      <div v-if="isCreateModal"
        ...
        <div class="bg-white dark:bg-gray-900 w-full max-w-md p-6 rounded-xl shadow-xl">
          ...
          <h2 class="text-xl font-semibold mb-4 text-blue-800 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">
            {{ isEditMode ? "Edit System Title" : "Create System Title" }}
          </h2>
