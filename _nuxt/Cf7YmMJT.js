const r=()=>({showToast:(c,i,n="success")=>{const e={success:{icon:"✅",bg:"#74EBBD"},warning:{icon:"⚠️",bg:"#D5A24A"},error:{icon:"❌",bg:"#EF4444"}}[n];let s=document.getElementById("custom-toast-container");s||(s=document.createElement("div"),s.id="custom-toast-container",document.body.appendChild(s));const t=document.createElement("div");t.className="my-custom-toast",t.style.backgroundColor=e.bg,t.innerHTML=`
