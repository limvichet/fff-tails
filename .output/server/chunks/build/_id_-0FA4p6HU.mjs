...
import { _ as _export_sfc, u as useHead, w as useRequestHeaders } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      if (unref(errorMsg)) {
        _push(`<div class="mb-3 p-2 rounded bg-red-500/20 text-red-300 text-sm" data-v-1cb42697>${ssrInterpolate(unref(errorMsg))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(successMsg)) {
        _push(`<div class="mb-3 p-2 rounded bg-emerald-500/20 text-emerald-300 text-sm" data-v-1cb42697>${ssrInterpolate(unref(successMsg))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(customer)) {
        _push(`<div class="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3" data-v-1cb42697><div class="lg:col-span-2 grid grid-cols-1 gap-2 sm:grid-cols-1 lg:grid-cols-2" data-v-1cb42697><div class="space-y-4" data-v-1cb42697>`);
        _push(ssrRenderComponent(ComponentCard, { title: "1. Basic" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Title <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_title_1)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" disabled data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_title_1) ? ssrLooseContain(unref(form).cust_title_1, "-1") : ssrLooseEqual(unref(form).cust_title_1, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(nameTitles), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_title_1) ? ssrLooseContain(unref(form).cust_title_1, dd.id) : ssrLooseEqual(unref(form).cust_title_1, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Name <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_name_1)}</span></div><input${ssrRenderAttr("value", unref(form).cust_name_1)} type="text" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Date of Birth <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_dob_1)}</span></div><input${ssrRenderAttr("value", unref(form).cust_dob_1)} type="date" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>ID Card Number <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_idcardnum_1)}</span></div><input${ssrRenderAttr("value", unref(form).cust_idcardnum_1)} type="text" class="input" maxlength="9" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Identity Type <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).iden_id_1)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" disabled data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).iden_id_1) ? ssrLooseContain(unref(form).iden_id_1, "-1") : ssrLooseEqual(unref(form).iden_id_1, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(identifications), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).iden_id_1) ? ssrLooseContain(unref(form).iden_id_1, dd.id) : ssrLooseEqual(unref(form).iden_id_1, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Date Identification <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_idcardnum_date_1)}</span></div><input${ssrRenderAttr("value", unref(form).cust_idcardnum_date_1)} type="date" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Identification Licenses <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).idli_id_1)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" disabled data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).idli_id_1) ? ssrLooseContain(unref(form).idli_id_1, "-1") : ssrLooseEqual(unref(form).idli_id_1, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(idLicenses), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).idli_id_1) ? ssrLooseContain(unref(form).idli_id_1, dd.id) : ssrLooseEqual(unref(form).idli_id_1, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Occupation <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).occu_id_1)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" disabled data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).occu_id_1) ? ssrLooseContain(unref(form).occu_id_1, "-1") : ssrLooseEqual(unref(form).occu_id_1, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(occupations), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).occu_id_1) ? ssrLooseContain(unref(form).occu_id_1, dd.id) : ssrLooseEqual(unref(form).occu_id_1, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Phone <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_phone_1)}</span></div><input${ssrRenderAttr("value", unref(form).cust_phone_1)} type="text" maxlength="10" class="input" data-v-1cb42697${_scopeId}></div>`);
            } else {
              return [
        ...
        _push(`</div><div class="space-y-4" data-v-1cb42697>`);
        _push(ssrRenderComponent(ComponentCard, { title: "2. Basic" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Title</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_title_2)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_title_2) ? ssrLooseContain(unref(form).cust_title_2, "-1") : ssrLooseEqual(unref(form).cust_title_2, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(nameTitles), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_title_2) ? ssrLooseContain(unref(form).cust_title_2, dd.id) : ssrLooseEqual(unref(form).cust_title_2, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Name</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_name_2)}</span></div><input${ssrRenderAttr("value", unref(form).cust_name_2)} type="text" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Date of Birth</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_dob_2)}</span></div><input${ssrRenderAttr("value", unref(form).cust_dob_2)} type="date" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>ID Card Number</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_idcardnum_2)}</span></div><input${ssrRenderAttr("value", unref(form).cust_idcardnum_2)} type="text" class="input" maxlength="9" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Identity Type</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).iden_id_2)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).iden_id_2) ? ssrLooseContain(unref(form).iden_id_2, "-1") : ssrLooseEqual(unref(form).iden_id_2, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(identifications), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).iden_id_2) ? ssrLooseContain(unref(form).iden_id_2, dd.id) : ssrLooseEqual(unref(form).iden_id_2, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Date Identification</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_idcardnum_date_2)}</span></div><input${ssrRenderAttr("value", unref(form).cust_idcardnum_date_2)} type="date" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Identification Licenses</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).idli_id_2)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).idli_id_2) ? ssrLooseContain(unref(form).idli_id_2, "-1") : ssrLooseEqual(unref(form).idli_id_2, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(idLicenses), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).idli_id_2) ? ssrLooseContain(unref(form).idli_id_2, dd.id) : ssrLooseEqual(unref(form).idli_id_2, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Occupation</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).occu_id_2)}</span></div><select class="input" data-v-1cb42697${_scopeId}><option value="-1" data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).occu_id_2) ? ssrLooseContain(unref(form).occu_id_2, "-1") : ssrLooseEqual(unref(form).occu_id_2, "-1")) ? " selected" : ""}${_scopeId}> Choose ... </option><!--[-->`);
              ssrRenderList(unref(occupations), (dd) => {
                _push2(`<option${ssrRenderAttr("value", dd.id)} data-v-1cb42697${ssrIncludeBooleanAttr(Array.isArray(unref(form).occu_id_2) ? ssrLooseContain(unref(form).occu_id_2, dd.id) : ssrLooseEqual(unref(form).occu_id_2, dd.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(dd.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Phone</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_phone_2)}</span></div><input${ssrRenderAttr("value", unref(form).cust_phone_2)} type="text" maxlength="10" class="input" data-v-1cb42697${_scopeId}></div>`);
            } else {
              return [
                createVNode("div", null, [
                  createVNode("div", { class: "flex items-center justify-between" }, [
        ...
        _push(`</div><div data-v-1cb42697>`);
        _push(ssrRenderComponent(ComponentGrowCard, { title: "4.Bank Infomation" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Account Number</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_account_num)}</span></div><input${ssrRenderAttr("value", unref(form).cust_account_num)} type="text" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>ATM Number</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_atm_num)}</span></div><input${ssrRenderAttr("value", unref(form).cust_atm_num)} type="text" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="${ssrRenderClass([
                "label",
                unref(isFacebookValid) ? "cursor-pointer !text-blue-900" : "text-gray-400"
              ])}" data-v-1cb42697${_scopeId}> Facebook `);
              if (unref(isFacebookValid)) {
                _push2(`<span data-v-1cb42697${_scopeId}> 🔗</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</label></div><input${ssrRenderAttr("value", unref(form).cust_facebook)} type="text" class="input" data-v-1cb42697${_scopeId}></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label style="${ssrRenderStyle({ "margin-bottom": "4px", "font-size": "14px", "color": "#555" })}" class="${ssrRenderClass([
                "inline-flex items-center gap-1 hover:text-blue-700",
                unref(isTelegramValid) ? "cursor-pointer !text-blue-900" : "text-gray-400"
              ])}" data-v-1cb42697${_scopeId}> Telegram `);
              if (unref(isTelegramValid)) {
                _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" data-v-1cb42697${_scopeId}><path d="M9.5 13.01l-.39 4.44c.56 0 .8-.24 1.1-.52l2.64-2.53 5.48 4.01c1 .53 1.72.25 1.98-.93L23 2.98c.26-1.18-.43-1.65-1.3-1.38L1.74 9.66c-1.17.46-1.15 1.11-.2 1.38l5.5 1.7 12.77-8c.6-.38 1.15-.17.7.25l-10.6 10z" data-v-1cb42697${_scopeId}></path></svg>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</label></div><input${ssrRenderAttr("value", unref(form).cust_telegram)} type="text" class="input" data-v-1cb42697${_scopeId}></div>`);
            } else {
              return [
                createVNode("div", null, [
                  createVNode("div", { class: "flex items-center justify-between" }, [
        ...
        _push(ssrRenderComponent(ComponentGrowCard, { title: "5.Address Infomation" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Address <span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).cust_address)}</span></div><textarea class="input" rows="4" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(form).cust_address)}</textarea></div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="${ssrRenderClass([
                "label",
                unref(isAddressValid) ? "cursor-pointer !text-blue-900" : "text-gray-400"
              ])}" data-v-1cb42697${_scopeId}> Map link `);
              if (unref(isAddressValid)) {
                _push2(`<span data-v-1cb42697${_scopeId}> 📌</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</label></div><input${ssrRenderAttr("value", unref(form).cust_address_link)} class="input" data-v-1cb42697${_scopeId}></div>`);
            } else {
              return [
                createVNode("div", null, [
                  createVNode("div", { class: "flex items-center justify-between" }, [
        ...
        _push(`</div></div><div class="lg:col-span-1 grid grid-cols-1" data-v-1cb42697><div class="space-y-4" data-v-1cb42697>`);
        _push(ssrRenderComponent(ComponentGrowCard, { title: "3. Identification Photo" }, {
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition" data-v-1cb42697${_scopeId}>`);
              if (unref(loading)) {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>ID Card Image 1</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).img1)}</span></div><input type="file" class="input" data-v-1cb42697${_scopeId}>`);
              if (unref(form).img1_src) {
                _push2(`<div class="mt-4" data-v-1cb42697${_scopeId}><div class="relative group w-full" data-v-1cb42697${_scopeId}><a${ssrRenderAttr("href", unref(form).img1_src)} target="_blank" rel="noopener noreferrer" class="block" data-v-1cb42697${_scopeId}><img${ssrRenderAttr("src", unref(form).img1_src)} class="w-full h-50 object-cover rounded-xl border shadow-md transition duration-300 hover:scale-[1.02] cursor-pointer" data-v-1cb42697${_scopeId}></a><div class="absolute top-3 right-3 bg-white/90 backdrop-blur px-3 py-1.5 rounded-full shadow flex items-center gap-2 pointer-events-none" data-v-1cb42697${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).img1_check) ? ssrLooseContain(unref(form).img1_check, null) : unref(form).img1_check) ? " checked" : ""} class="w-4 h-4 text-blue-600 rounded pointer-events-auto" data-v-1cb42697${_scopeId}><span class="text-sm text-gray-700" data-v-1cb42697${_scopeId}>Check</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>ID Card Image 2</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).img2)}</span></div><input type="file" class="input" data-v-1cb42697${_scopeId}>`);
              if (unref(form).img2_src) {
                _push2(`<div class="mt-4" data-v-1cb42697${_scopeId}><div class="relative group w-full" data-v-1cb42697${_scopeId}><a${ssrRenderAttr("href", unref(form).img2_src)} target="_blank" rel="noopener noreferrer" class="block" data-v-1cb42697${_scopeId}><img${ssrRenderAttr("src", unref(form).img2_src)} class="w-full h-50 object-cover rounded-xl border shadow-md transition duration-300 hover:scale-[1.02] cursor-pointer" data-v-1cb42697${_scopeId}></a><div class="absolute top-3 right-3 bg-white/90 backdrop-blur px-3 py-1.5 rounded-full shadow flex items-center gap-2 pointer-events-none" data-v-1cb42697${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).img2_check) ? ssrLooseContain(unref(form).img2_check, null) : unref(form).img2_check) ? " checked" : ""} class="w-4 h-4 text-blue-600 rounded pointer-events-auto" data-v-1cb42697${_scopeId}><span class="text-sm text-gray-700" data-v-1cb42697${_scopeId}>Check</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Photo 1</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).photo1)}</span></div><input type="file" class="input" data-v-1cb42697${_scopeId}>`);
              if (unref(form).photo1_src) {
                _push2(`<div class="mt-4" data-v-1cb42697${_scopeId}><div class="relative group w-1/2" data-v-1cb42697${_scopeId}><a${ssrRenderAttr("href", unref(form).photo1_src)} target="_blank" rel="noopener noreferrer" class="block" data-v-1cb42697${_scopeId}><img${ssrRenderAttr("src", unref(form).photo1_src)} class="w-full h-52 object-cover rounded-xl border shadow-md transition duration-300 hover:scale-[1.02] cursor-pointer" data-v-1cb42697${_scopeId}></a><div class="absolute top-1 right-1 bg-white/50 backdrop-blur px-2 py-1 rounded-full shadow flex items-center gap-2 pointer-events-none" data-v-1cb42697${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).photo1_check) ? ssrLooseContain(unref(form).photo1_check, null) : unref(form).photo1_check) ? " checked" : ""} class="w-4 h-4 text-blue-600 rounded pointer-events-auto" data-v-1cb42697${_scopeId}><span class="text-sm text-gray-700" data-v-1cb42697${_scopeId}>Check</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div data-v-1cb42697${_scopeId}><div class="flex items-center justify-between" data-v-1cb42697${_scopeId}><label class="label" data-v-1cb42697${_scopeId}>Photo 2</label><span class="text-red-500 text-sm" data-v-1cb42697${_scopeId}>${ssrInterpolate(unref(errors).photo2)}</span></div><input type="file" class="input" data-v-1cb42697${_scopeId}>`);
              if (unref(form).photo2_src) {
                _push2(`<div class="mt-4" data-v-1cb42697${_scopeId}><div class="relative group w-1/2" data-v-1cb42697${_scopeId}><a${ssrRenderAttr("href", unref(form).photo2_src)} target="_blank" rel="noopener noreferrer" class="block" data-v-1cb42697${_scopeId}><img${ssrRenderAttr("src", unref(form).photo2_src)} class="w-full h-52 object-cover rounded-xl border shadow-md transition duration-300 hover:scale-[1.02] cursor-pointer" data-v-1cb42697${_scopeId}></a><div class="absolute top-3 right-3 bg-white/90 backdrop-blur px-3 py-1.5 rounded-full shadow flex items-center gap-2 pointer-events-none" data-v-1cb42697${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).photo2_check) ? ssrLooseContain(unref(form).photo2_check, null) : unref(form).photo2_check) ? " checked" : ""} class="w-4 h-4 text-blue-600 rounded pointer-events-auto" data-v-1cb42697${_scopeId}><span class="text-sm text-gray-700" data-v-1cb42697${_scopeId}>Check</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/app/dashboard/customers/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1cb42697"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-0FA4p6HU.mjs.map
