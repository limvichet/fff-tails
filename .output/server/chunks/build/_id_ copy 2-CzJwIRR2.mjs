import { defineComponent, ref, reactive, withAsyncContext, computed, watchEffect, watch, unref, withCtx, createVNode, withDirectives, createBlock, createCommentVNode, createTextVNode, toDisplayString, withModifiers, openBlock, Fragment, renderList, vModelSelect, isRef, vModelText, vModelCheckbox, useSSRContext } from 'vue';
...
import { _ as _export_sfc, g as useAuth, w as useRequestHeaders } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      if (unref(errorMsg)) {
        _push(`<div class="mb-3 p-2 rounded bg-red-500/20 text-red-300 text-sm" data-v-c29685a0>${ssrInterpolate(unref(errorMsg))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(successMsg)) {
        _push(`<div class="mb-3 p-2 rounded bg-emerald-500/20 text-emerald-300 text-sm" data-v-c29685a0>${ssrInterpolate(unref(successMsg))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(loanrecord)) {
        _push(`<div class="grid grid-cols-1 lg:grid-cols-3 gap-4" data-v-c29685a0>`);
        _push(ssrRenderComponent(ComponentCard, { title: "1. General Information" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="relative select-container" data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Customer<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).cust_id)}</span></div><select class="input w-full" data-v-c29685a0${_scopeId}><option value="" class="hidden" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_id) ? ssrLooseContain(unref(form).cust_id, "") : ssrLooseEqual(unref(form).cust_id, "")) ? " selected" : ""}${_scopeId}>Select customer</option><!--[-->`);
              ssrRenderList(unref(customerName1), (c) => {
                _push2(`<option${ssrRenderAttr("value", c.id)} class="hidden" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_id) ? ssrLooseContain(unref(form).cust_id, c.id) : ssrLooseEqual(unref(form).cust_id, c.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(c.label)}</option>`);
              });
              _push2(`<!--]--></select>`);
              if (unref(isOpen)) {
                _push2(`<div class="absolute z-10 w-full mt-1" data-v-c29685a0${_scopeId}><input type="text"${ssrRenderAttr("value", unref(search))} placeholder="Search ..." class="input w-full border rounded px-3 py-2 bg-white text-black dark:bg-gray-800 dark:text-white dark:border-gray-700" autocomplete="off" data-v-c29685a0${_scopeId}>`);
                if (unref(filteredCustomers).length) {
                  _push2(`<ul class="absolute z-10 w-full mt-1 max-h-40 overflow-auto border rounded bg-white text-black dark:bg-gray-800 dark:text-white dark:border-gray-700" data-v-c29685a0${_scopeId}><!--[-->`);
                  ssrRenderList(unref(filteredCustomers), (c, index) => {
                    ...
                    ])}" data-v-c29685a0${_scopeId}>${ssrInterpolate(c.id)} - ${ssrInterpolate(c.label)}</li>`);
                  });
                  _push2(`<!--]--></ul>`);
                } else {
                  _push2(`<!---->`);
              ...
              _push2(`</div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Currency<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).currency_id)}</span></div><select class="input" data-v-c29685a0${_scopeId}><!--[-->`);
              ssrRenderList(unref(currencies), (c) => {
                _push2(`<option${ssrRenderAttr("value", c.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).currency_id) ? ssrLooseContain(unref(form).currency_id, c.id) : ssrLooseEqual(unref(form).currency_id, c.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(c.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Last Cash<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_lastcash)}</span></div><input type="text" class="input"${ssrRenderAttr("value", unref(form).loan_lastcash.toLocaleString())} data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>New Cash<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_newcash)}</span></div><input type="text" class="input"${ssrRenderAttr("value", unref(form).loan_newcash.toLocaleString())} data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Total Cash<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_totalcash)}</span></div><input type="text" class="input bg-gray-100 cursor-not-allowed"${ssrRenderAttr("value", unref(form).loan_totalcash.toLocaleString(void 0, { minimumFractionDigits: 2, maximumFractionDigits: 2 }))} readonly data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Principle<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_principle)}</span></div><input type="text" class="input"${ssrRenderAttr("value", unref(form).loan_principle.toLocaleString())} data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Source Money<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).source_money)}</span></div><input${ssrRenderAttr("value", unref(form).source_money)} list="sourceMoneyList" class="input" placeholder="Type source..." data-v-c29685a0${_scopeId}><datalist id="sourceMoneyList" data-v-c29685a0${_scopeId}><!--[-->`);
              ssrRenderList(unref(sourceMoneys), (s) => {
                _push2(`<option${ssrRenderAttr("value", s)} data-v-c29685a0${_scopeId}></option>`);
              });
              _push2(`<!--]--></datalist></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Loan Type<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loantype_id)}</span></div><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).loantype_id) ? ssrLooseContain(unref(form).loantype_id, "-1") : ssrLooseEqual(unref(form).loantype_id, "-1")) ? " selected" : ""}${_scopeId}>Choose...</option><!--[-->`);
              ssrRenderList(unref(loanTypes), (l) => {
                _push2(`<option${ssrRenderAttr("value", l.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).loantype_id) ? ssrLooseContain(unref(form).loantype_id, l.id) : ssrLooseEqual(unref(form).loantype_id, l.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(l.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Over Draft</label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_over_draft)}</span></div><input type="text" class="input"${ssrRenderAttr("value", unref(form).loan_over_draft.toLocaleString())} data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Payback<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).payback_id)}</span></div><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).payback_id) ? ssrLooseContain(unref(form).payback_id, "-1") : ssrLooseEqual(unref(form).payback_id, "-1")) ? " selected" : ""}${_scopeId}>Choose...</option><!--[-->`);
              ssrRenderList(unref(paybacks), (l) => {
                _push2(`<option${ssrRenderAttr("value", l.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).payback_id) ? ssrLooseContain(unref(form).payback_id, l.id) : ssrLooseEqual(unref(form).payback_id, l.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(l.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Loan Period<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_peroid)}</span></div><input${ssrRenderAttr("value", unref(form).loan_peroid)} type="number" class="input" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Start Date<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_startdate)}</span></div><input${ssrRenderAttr("value", unref(form).loan_startdate)} type="date" class="input" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>End Date<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_enddate)}</span></div><input${ssrRenderAttr("value", unref(form).loan_enddate)} type="date" class="input" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Interest Rate (%) <span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_interest_rate)}</span></div><input${ssrRenderAttr("value", unref(form).loan_interest_rate)} type="number" step="0.01" class="input" data-v-c29685a0${_scopeId}></div>`);
            } else {
              return [
                createVNode("div", { class: "relative select-container" }, [
                  createVNode("div", { class: "flex items-center justify-between" }, [
                    ...
                    createVNode("span", { class: "text-red-500 text-sm" }, toDisplayString(unref(errors).cust_id), 1)
                  ]),
        ...
        _push(ssrRenderComponent(ComponentCard, { title: "2. Guarantor/Comission" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Comission Customer<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).cust_comission_id)}</span><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_comission_id) ? ssrLooseContain(unref(form).cust_comission_id, "-1") : ssrLooseEqual(unref(form).cust_comission_id, "-1")) ? " selected" : ""}${_scopeId}>Choose ...</option><!--[-->`);
              ssrRenderList(unref(customerName1), (c) => {
                _push2(`<option${ssrRenderAttr("value", c.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_comission_id) ? ssrLooseContain(unref(form).cust_comission_id, c.id) : ssrLooseEqual(unref(form).cust_comission_id, c.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(String(c.id).padStart(8, "0"))} - ${ssrInterpolate(c.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Comission Interest Rate (%)<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).cust_comission_interest_rate)}</span><input${ssrRenderAttr("value", unref(form).cust_comission_interest_rate)} type="number" step="0.01" class="input" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Loan Group<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).cust_loangroup_id)}</span><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_loangroup_id) ? ssrLooseContain(unref(form).cust_loangroup_id, "-1") : ssrLooseEqual(unref(form).cust_loangroup_id, "-1")) ? " selected" : ""}${_scopeId}>Choose ...</option><!--[-->`);
              ssrRenderList(unref(customerName1), (c) => {
                _push2(`<option${ssrRenderAttr("value", c.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_loangroup_id) ? ssrLooseContain(unref(form).cust_loangroup_id, c.id) : ssrLooseEqual(unref(form).cust_loangroup_id, c.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(String(c.id).padStart(8, "0"))} - ${ssrInterpolate(c.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Guarantor Customer</label><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_guarantor_id) ? ssrLooseContain(unref(form).cust_guarantor_id, "-1") : ssrLooseEqual(unref(form).cust_guarantor_id, "-1")) ? " selected" : ""}${_scopeId}>Choose ...</option><!--[-->`);
              ssrRenderList(unref(customerName1), (c) => {
                _push2(`<option${ssrRenderAttr("value", c.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_guarantor_id) ? ssrLooseContain(unref(form).cust_guarantor_id, c.id) : ssrLooseEqual(unref(form).cust_guarantor_id, c.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(String(c.id).padStart(8, "0"))} - ${ssrInterpolate(c.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Position in Loan Group<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).cust_position_loangroup_id)}</span><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_position_loangroup_id) ? ssrLooseContain(unref(form).cust_position_loangroup_id, "-1") : ssrLooseEqual(unref(form).cust_position_loangroup_id, "-1")) ? " selected" : ""}${_scopeId}>Choose ...</option><!--[-->`);
              ssrRenderList(unref(loanGroupPositions), (c) => {
                _push2(`<option${ssrRenderAttr("value", c.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).cust_position_loangroup_id) ? ssrLooseContain(unref(form).cust_position_loangroup_id, c.id) : ssrLooseEqual(unref(form).cust_position_loangroup_id, c.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(c.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Invoice ID</label></div><input${ssrRenderAttr("value", unref(form).invoice_id)} type="text" class="input" readonly data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Status<span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}> *</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_status_id)}</span></div><select class="input" data-v-c29685a0${_scopeId}><option value="-1" data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).loan_status_id) ? ssrLooseContain(unref(form).loan_status_id, "-1") : ssrLooseEqual(unref(form).loan_status_id, "-1")) ? " selected" : ""}${_scopeId}>Choose...</option><!--[-->`);
              ssrRenderList(unref(loanStatuses), (l) => {
                _push2(`<option${ssrRenderAttr("value", l.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).loan_status_id) ? ssrLooseContain(unref(form).loan_status_id, l.id) : ssrLooseEqual(unref(form).loan_status_id, l.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(l.label)}</option>`);
              });
              _push2(`<!--]--></select></div><div class="${ssrRenderClass({ hidden: !(unref(hasRole)("admin") || unref(hasRole)("ceo")) })}" data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Approver</label></div><select class="input" data-v-c29685a0${_scopeId}><!--[-->`);
              ssrRenderList(unref(loanCheckStatuses), (l) => {
                _push2(`<option${ssrRenderAttr("value", l.id)} data-v-c29685a0${ssrIncludeBooleanAttr(Array.isArray(unref(form).loan_check_status) ? ssrLooseContain(unref(form).loan_check_status, l.id) : ssrLooseEqual(unref(form).loan_check_status, l.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(l.label)}</option>`);
              });
              _push2(`<!--]--></select></div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(ComponentGrowCard, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-c29685a0${_scopeId}><button type="button"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} class="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-2 text-sm font-medium text-white transition shadow hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-blue-400" data-v-c29685a0${_scopeId}>`);
              if (unref(loading)) {
                _push2(`<svg class="w-5 h-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" data-v-c29685a0${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-c29685a0${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z" data-v-c29685a0${_scopeId}></path></svg>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(loading) ? "Saving..." : "Update Loan")}</span></button></div>`);
            } else {
              return [
                createVNode("div", null, [
                  createVNode("button", {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label !text-blue-900 text-bold -ml-1" data-v-c29685a0${_scopeId}>Collateral 1 - Description</label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_collateral_1)}</span></div><textarea class="input" rows="6" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(form).loan_collateral_1)}</textarea></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="${ssrRenderClass([
                "label",
                unref(isloan_collateral_map_link_1_Valid) ? "cursor-pointer !text-blue-900" : "text-gray-400"
              ])}" data-v-c29685a0${_scopeId}> Collateral 1 Map link `);
              if (unref(isloan_collateral_map_link_1_Valid)) {
                _push2(`<span data-v-c29685a0${_scopeId}> 📌</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</label></div><input${ssrRenderAttr("value", unref(form).loan_collateral_map_link_1)} class="input" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Collateral 1 - Document <span class="!text-red-300" data-v-c29685a0${_scopeId}>PDF</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_collateral_doc_1)}</span></div><input type="file" accept="application/pdf" class="input" data-v-c29685a0${_scopeId}>`);
              if (unref(form).loan_collateral_doc_1_src) {
                _push2(`<div class="mt-3" data-v-c29685a0${_scopeId}><div class="relative group w-full" data-v-c29685a0${_scopeId}><a${ssrRenderAttr("href", getFileUrl(unref(form).loan_collateral_doc_1_src))} target="_blank" class="flex items-center justify-between p-3 hover:bg-gray-50 transition" data-v-c29685a0${_scopeId}><div class="flex items-center gap-3" data-v-c29685a0${_scopeId}><div class="w-10 h-10 flex items-center justify-center bg-red-100 text-red-600 rounded-lg" data-v-c29685a0${_scopeId}> PDF </div><div class="flex flex-col" data-v-c29685a0${_scopeId}><span class="text-sm font-medium text-gray-800" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(form).loan_collateral_doc_1?.name || "document.pdf")}</span><span class="text-xs text-gray-500" data-v-c29685a0${_scopeId}>${ssrInterpolate(formatFileSize(unref(form).loan_collateral_doc_1?.size))}</span></div></div></a><div class="absolute bottom-1 right-2 bg-white/90 backdrop-blur px-3 py-1 rounded-full shadow flex items-center gap-2" data-v-c29685a0${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).loan_collateral_doc_1_check, 1)) ? " checked" : ""} class="w-4 h-4 text-blue-600 rounded" data-v-c29685a0${_scopeId}><span class="text-sm text-gray-700" data-v-c29685a0${_scopeId}>Check</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="border-b border-gray-100 dark:border-gray-800 !pt-3" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Collateral 2</label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_collateral_2)}</span></div><textarea class="input" rows="6" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(form).loan_collateral_2)}</textarea></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="${ssrRenderClass([
                "label",
                unref(isloan_collateral_map_link_2_Valid) ? "cursor-pointer !text-blue-900" : "text-gray-400"
              ])}" data-v-c29685a0${_scopeId}> Collateral 2 Map link `);
              if (unref(isloan_collateral_map_link_2_Valid)) {
                _push2(`<span data-v-c29685a0${_scopeId}> 📌</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</label></div><input${ssrRenderAttr("value", unref(form).loan_collateral_map_link_2)} class="input" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Collateral 2 - Document <span class="!text-red-300" data-v-c29685a0${_scopeId}>PDF</span></label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_collateral_doc_2)}</span></div><input type="file" accept="application/pdf" class="input" data-v-c29685a0${_scopeId}>`);
              if (unref(form).loan_collateral_doc_2_src) {
                _push2(`<div class="mt-3" data-v-c29685a0${_scopeId}><div class="relative group w-full" data-v-c29685a0${_scopeId}><a${ssrRenderAttr("href", getFileUrl(unref(form).loan_collateral_doc_2_src))} target="_blank" class="flex items-center justify-between p-3 hover:bg-gray-50 transition" data-v-c29685a0${_scopeId}><div class="flex items-center gap-3" data-v-c29685a0${_scopeId}><div class="w-10 h-10 flex items-center justify-center bg-red-100 text-red-600 rounded-lg" data-v-c29685a0${_scopeId}> PDF </div><div class="flex flex-col" data-v-c29685a0${_scopeId}><span class="text-sm font-medium text-gray-800" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(form).loan_collateral_doc_2?.name || "document.pdf")}</span><span class="text-xs text-gray-500" data-v-c29685a0${_scopeId}>${ssrInterpolate(formatFileSize(unref(form).loan_collateral_doc_2?.size))}</span></div></div></a><div class="absolute bottom-1 right-2 bg-white/90 backdrop-blur px-3 py-1 rounded-full shadow flex items-center gap-2" data-v-c29685a0${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(form).loan_collateral_doc_2_check, 1)) ? " checked" : ""} class="w-4 h-4 text-blue-600 rounded" data-v-c29685a0${_scopeId}><span class="text-sm text-gray-700" data-v-c29685a0${_scopeId}>Check</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="border-b border-gray-100 dark:border-gray-800 pt-3" data-v-c29685a0${_scopeId}></div><div data-v-c29685a0${_scopeId}><div class="flex items-center justify-between" data-v-c29685a0${_scopeId}><label class="label" data-v-c29685a0${_scopeId}>Note</label><span class="text-red-500 text-sm" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(errors).loan_note)}</span></div><textarea class="input" rows="6" data-v-c29685a0${_scopeId}>${ssrInterpolate(unref(form).loan_note)}</textarea></div>`);
            } else {
              return [
                createVNode("div", null, [
                  createVNode("div", { class: "flex items-center justify-between" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/app/dashboard/loanrecords/[id] copy 2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id__copy_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c29685a0"]]);

export { _id__copy_2 as default };
//# sourceMappingURL=_id_ copy 2-CzJwIRR2.mjs.map
