import { d as defineEventHandler, u as useRuntimeConfig, g as getCookie, b as getRouterParam, c as createError, f as readBody } from '../../../../nitro/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _id_ = defineEventHandler(async (event) => {
  ...
  const url = `${config.apiBaseUrl}/api/admin-secure/user-permissions/${id}`;
