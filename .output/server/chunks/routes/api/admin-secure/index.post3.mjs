...
const index_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch(`${apiBaseUrl}/api/admin-secure/loanrecords`, {
      method: "POST",
      body: formData,
      headers: {
    ...
    const message = ((_a = err == null ? void 0 : err.data) == null ? void 0 : _a.message) || (err == null ? void 0 : err.message) || "Failed to create loanrecord";
    throw createError({
