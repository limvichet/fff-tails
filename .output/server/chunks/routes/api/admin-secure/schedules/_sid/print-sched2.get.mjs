...
const printSched2_get = defineEventHandler(async (event) => {
  var _a, _b;
  ...
  const sid = (_a = event.context.params) == null ? void 0 : _a.sid;
  try {
    const res = await $fetch(
      `${apiBaseUrl}/api/admin-secure/schedules/${sid}/print-sched2`,
      {
        method: "GET",
        headers: {
...
export { printSched2_get as default };
//# sourceMappingURL=print-sched2.get.mjs.map
