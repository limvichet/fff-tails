...
const loanrecordsFormData_get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const res = await $fetch(
      `${apiBaseUrl}/api/admin-secure/loanrecords-form-data`,
      {
        method: "GET",
        headers: {
...
export { loanrecordsFormData_get as default };
//# sourceMappingURL=loanrecords-form-data.get.mjs.map
