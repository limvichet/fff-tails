...
const login_post_copy_2 = defineEventHandler(async (event) => {
  try {
    ...
    const { token, user, roles, permissions } = await $fetch(
...
export { login_post_copy_2 as default };
//# sourceMappingURL=login.post copy 2.mjs.map
